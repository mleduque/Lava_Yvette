...
IF~~THEN REPLY @4 /* Wow, a talking scroll! That's new. */ GOTO YvP1x01 
IF~~THEN REPLY @5 /* I only know your name, it’s Yvette. I thought you were just a drawing... */ GOTO YvP1x02 
IF~~THEN REPLY @6 /* I guess your name is Yvette - there's a line that mentions it. I thought you were a simple drawing, when suddenly you started to move. */ GOTO YvP1x02 
IF~~THEN REPLY @7 /* Yikes! By the Gods, a talking scroll! (Throw the scroll away.) */ DO ~SetGlobal("YvetteRomanceActive","GLOBAL",3) SetGlobal("YvetteRomanceTalk","GLOBAL",1) DestroyItem("YxDraw")~ EXIT 
END 

IF~~THEN BEGIN YvP1x01 
SAY @8 /* A scroll? What am I? Do you know my name? Please, tell me. */ 
IF~~THEN REPLY @9 /* "For my Yvette" is written on the scroll. I suppose that would be you. I'm not sure how to put this, but...you're a drawing. */ GOTO YvP1x02 
IF~~THEN REPLY @10 /* Forget it. I don't have time for this. (Throw the drawing away.) */ GOTO YvP1x03 
END 

IF~~THEN BEGIN YvP1x02 
SAY @11 /* Yvette... Yes, I remember this name. It...it might be me. Thank you. */
...
IF~~THEN REPLY @14 /* I think that you were like that for a long time. Nobody guessed that you might be something more than coal lines on parchment. */ GOTO YvP1x04 
IF~~THEN REPLY @15 /* I don't care who you are. Just tell me - can you do anything *useful*? */ GOTO YvP1x05
IF~~THEN REPLY @16 /* I don't know who you are, lady, but perhaps time will tell. Maybe we can recover your memories. */ GOTO YvP1x04
IF~~THEN REPLY @17 /* I'm not interested in who and what you are. Question is, can you help me on the road or in a fight? */ GOTO YvP1x05
END 

IF~~THEN BEGIN YvP1x04 
SAY @18 /* (Yvette stays silent for a moment, but soon you can hear her voice again.) */
...
IF~~THEN REPLY @21 /* I mean you well, Yvette. Don't worry, I won't throw you away. */ GOTO YvP1x06 
IF~~THEN REPLY @22 /* Hehe, don't be so afraid, Yvette. Of course you may stay with us - there's no problem with that. */ GOTO YvP1x06
IF~~THEN REPLY @23 /* I don't need another burden. (toss the scroll away.) */ DO ~SetGlobal("YvetteRomanceActive","GLOBAL",3) SetGlobal("YvetteRomanceTalk","GLOBAL",1) DestroyItem("YxDraw")~ EXIT 
END 

IF~~THEN BEGIN YvP1x06 
SAY @24 /* (smiles) Thank you. I forgot to ask you your name. Please, I would like to know it. */
IF~~THEN REPLY @25 /* It's <CHARNAME>. */ GOTO YvP1x07 
IF~~THEN REPLY @26 /* My name is <CHARNAME>. Pleased to meet you, Yvette. */ GOTO YvP1x07 
IF~~THEN REPLY @27 /* Forget it. I'll take you with me, but you don't need to know my name. */ GOTO YvP1x08 
END 
...
SAY @31 /* I understand. I will remain with you as long as I can. Thank you for agreeing to bring me along. */ 
IF~~THEN DO ~SetGlobal("YvetteRomanceActive","GLOBAL",3) SetGlobal("YvetteRomanceTalk","GLOBAL",1)~ EXIT 
END 

IF~~THEN BEGIN YvP1x05 
SAY @32 /* No...I do not think I can help you. */
IF~~THEN REPLY @33 /* I'm sorry. That was rude. It's just that I have no idea who you are...or *what* you are. */ GOTO YvP1x04 
IF~~THEN REPLY @34 /* I understand. Just forget the question. I'm a bit confused with the situation. */ GOTO YvP1x04 
IF~~THEN REPLY @35 /* So I don't need you. (Throw the scroll away.) */ DO ~SetGlobal("YvetteRomanceActive","GLOBAL",3) SetGlobal("YvetteRomanceTalk","GLOBAL",1) DestroyItem("YxDraw")~ EXIT 
END 

IF~~THEN BEGIN YvP1x03 
SAY @36 /* (You leave the scroll behind you and walk away.) */ 
...
SAY @37 /* Greetings, dear adventurer. Did you want to talk with me? (Lines of the drawing moves slowly - girl smiles.) */
IF~~THEN REPLY @38 /* I wanted to ask if you remembered anything. It must be...difficult...to lose your memory like that. */ GOTO YvP2x01 
IF~~THEN REPLY @39 /* You're just a useless drawing. What makes you think that I would want to talk with you? */ GOTO YvP2x02 
IF~~THEN REPLY @40 /* Of course, I always like to get to know my companions. I wanted to ask if you experienced any more memories. */ GOTO YvP2x01 
END 

IF~~THEN BEGIN YvP2x01 
SAY @41 /* Unfortunately, I remember nothing more than I did when we talked before. All I have is the name you told me. */ 
...
IF~~THEN REPLY @44 /* Adventurers have to face oddities in their lives, and besides, I like talking to you, Yvette. */ GOTO YvP2x03 
IF~~THEN REPLY @45 /* It is a bit weird, but I guess it could be worse. */ GOTO YvP2x04 
IF~~THEN REPLY @46 /* It is weird, and I don't like it. I don't want to talk with you. */ GOTO YvP2x02 
END 

IF~~THEN BEGIN YvP2x03 
SAY @47 /* Oh, if there were colours on this scroll, how I would blush! Hmm, what does it mean, to compliment a drawing? (Yvette laughs gently.) */ 
IF~~THEN GOTO YvP2x05 
END 

IF~~THEN BEGIN YvP2x04 
SAY @48 /* Yes, it could be worse. I could be an ugly old hag! */ 
...
SAY @66 /* (Yvette's face is calm as you unroll the scroll. Her eyes open, and she looks at you.) */ 
...
IF~~THEN REPLY @68 /* Of course, Yvette. I like to hear your voice. */ GOTO YvP3x01 
IF~~THEN REPLY @69 /* All right. */ GOTO YvP3x02 
IF~~THEN REPLY @70 /* I don't want to talk with you. */ GOTO YvP3x03 
END 

IF~~THEN BEGIN YvP3x01 
SAY @71 /* (Yvette smiles at you. She seems pleasantly surprised by your compliment.) */ 
IF~~THEN GOTO YvP3x02 
END 

IF~~THEN BEGIN YvP3x02 
SAY @72 /* Then I will tell you of it. */ 
...
SAY @73 /* You told me the story of this flower - Camila. She wanted to become a princess. As I said, I enjoyed that tale. */ 
= 
...
SAY @77 /* You know, I visited Darkmoss in my dream. It was terrifying at first, but it got better, just like in your story. */ 
= 
...
SAY @81 /* I have seen the hero you told me about. <PRO_HESHE> was a marvelous person, noble and pure of heart. You know, <PRO_HESHE> looked like you. Interesting, isn't it? */ 
= 
...
SAY @85 /* Did you like my story? */ 
IF~~THEN REPLY @86 /* Very much. I am a poor story teller compared to you, Yvette. */ GOTO YvP3x05 
IF~~THEN REPLY @87 /* It was unusual, but I enjoyed it. */ GOTO YvP3x06 
IF~~THEN REPLY @88 /* I think I fell asleep. Your "story" was dead boring. */ GOTO YvP3x07 
END 

IF~~THEN BEGIN YvP3x05 
SAY @89 /* Of course you're not! Without your tale I would not have had this dream. */ 
IF~~THEN DO ~SetGlobal("YvetteRomanceTalk","GLOBAL",3)~ EXIT 
END 

IF~~THEN BEGIN YvP3x06 
SAY @90 /* Thank you for listening to me. I'm glad that you liked my story . */ 
IF~~THEN DO ~SetGlobal("YvetteRomanceTalk","GLOBAL",3)~ EXIT 
END 

IF~~THEN BEGIN YvP3x07 
SAY @91 /* Really? It was so boring...? I see... I won't bother you, then. */ 
IF~~THEN DO ~SetGlobal("YvetteRomanceTalk","GLOBAL",3) SetGlobal("YvetteRomanceActive","GLOBAL",3)~ EXIT 
END 

IF~~THEN BEGIN YvP3x03
SAY @92 /* I see... I won't bother you then. */
IF~~THEN DO ~SetGlobal("YvetteRomanceTalk","GLOBAL",3) SetGlobal("YvetteRomanceActive","GLOBAL",3)~ EXIT 
END 
...
SAY @93 /* Hello, dear friend. It's a pleasure to see you again. (Yvette smiles playfully. She seems to rejoice in every opportunity to talk. Her sketched eyes are wide open, lending her face a cheerful, energetic look.) */
IF~~THEN REPLY @94 /* Why, greetings to you as well, my fair lady. Are you willing to talk to me? */ GOTO YvP4x01 
IF~~THEN REPLY @95 /* I have absolutely no desire to talk to you any longer. */ GOTO YvP4x02 
IF~~THEN REPLY @96 /* Are you in the mood to talk, Yvette? */ GOTO YvP4x01 
END 

IF~~THEN BEGIN YvP4x01
SAY @97 /* Indeed, I am! To be honest... I have something I would like to ask you. Do you mind...? */
IF~~THEN REPLY @98 /* By all means, ask away and I’ll do my best to answer.  Who wouldn't answer you? You are just the...the... oh, I am sure you know what I mean. */ GOTO YvP4x03 
IF~~THEN REPLY @99 /* Actually, I wanted to ask you something. How do you feel about your life now? */ GOTO YvP4x04 
IF~~THEN REPLY @100 /* I *do* mind. Why would I want to talk with a picture? */ GOTO YvP4x02 
END 

IF~~THEN BEGIN YvP4x03 
SAY @101 /* Are you trying to find out if you can make me blush? (Yvette bursts out laughing.) */
= 
...
IF~~THEN REPLY @103 /* It's like feeling the world moving around you. Sometimes it's just...wonderful. Other times, like in Icewind Dale, it's miserable and cold */ GOTO YvP4x05 
IF~~THEN REPLY @104 /* Wind is just...wind. Nothing special. It just happens. */ GOTO YvP4x06 
IF~~THEN REPLY @105 /* You are really annoying - you know that, don't you? */ GOTO YvP4x02 
END 

IF~~THEN BEGIN YvP4x05 
SAY @106 /* Quite descriptive, my <PRO_LADYLORD>. */
= 
...
SAY @108 /* Really? Well, I think differently - it seems like it should be something magical. */
= 
...
SAY @110 /* (Yvette smiles at you.) */
IF~~THEN GOTO YvP4x08 
END 

IF~~THEN BEGIN YvP4x04 
SAY @111 /* You don't want me to ask a question? I think I can answer yours, though.... */
= 
...
SAY @114 /* You know - when I looked at you, just now, I realized that you are...kind. Not everyone would give me so much attention. If I had a body I would kiss your cheek, my <PRO_LADYLORD>. You understand - to show how much I appreciate what you do for me. */
IF~~THEN REPLY @115 /* I'm honored to talk with someone as pleasant as you, Yvette. I don't need a reward for that. */ GOTO YvP4x09 
IF~~THEN REPLY @116 /* Thank you, Yvette. I bet you say that to all your friends. (Laugh.) */ GOTO YvP4x10
IF~~THEN REPLY @117 /* I don't care. If you really cared, you would leave me alone. */ GOTO YvP4x02
IF~~THEN REPLY @118 /* Hmm, someone here is quite slutty. */ GOTO YvP4x11
END 

IF~~THEN BEGIN YvP4x09 
SAY @119 /* You are a true gentle<PRO_MANWOMAN>, <CHARNAME>. */ 
IF~~THEN DO ~SetGlobal("YvetteRomanceTalk","GLOBAL",4)~ EXIT 
END 

IF~~THEN BEGIN YvP4x10 
SAY @120 /* Oh, of course! I have *plenty* of people to talk with. Oh, don't be silly, <CHARNAME>! You are my favorite person to talk with. (Yvette's bright smile is clearly directed at you.) */ 
IF~~THEN DO ~SetGlobal("YvetteRomanceTalk","GLOBAL",4)~ EXIT 
END 

IF~~THEN BEGIN YvP4x11 
SAY @121 /* That was rather rude. I didn't mean what you think I did. */ 
IF~~THEN DO ~SetGlobal("YvetteRomanceTalk","GLOBAL",4) SetGlobal("YvetteRomanceActive","GLOBAL",3)~ EXIT 
END 

IF~~THEN BEGIN YvP4x02 
SAY @122 /* I will bother you no more, then... */ 
IF~~THEN DO ~SetGlobal("YvetteRomanceTalk","GLOBAL",4) SetGlobal("YvetteRomanceActive","GLOBAL",3)~ EXIT 
END 
...
SAY @123 /* It is you... I... I think I remember something more about my past! It makes me feel such warmth... Lady Firehair. I remember Sune, the one I served. The Lady of Beauty! I am so glad after all of this...that I can remember something more than my name! You probably think I'm being silly, but... it's a marvelous feeling, finally remembering something. */ 
IF~~THEN REPLY @124 /* I don't think it's silly, Yvette. So you were a priestess of Sune? */ GOTO YvP5x01 
IF~~THEN REPLY @125 /* Cut down that idiotic behavior of yours, woman. */ GOTO YvP5x02 
IF~~THEN REPLY @126 /* I'm happy for you, Yvette. See? I told you that your memories will be back one day. You certainly sound happy about it. */ GOTO YvP5x01 
END 
...
IF~~THEN REPLY @129 /* You are right  your body may be caged, but your mind and faith aren't, Yvette. You are a prisoner only if you believe that you are. */ GOTO YvP5x03 
IF~~THEN REPLY @130 /* You're still trapped in your little scroll - you can't even *exist* like a normal person. And you call this freedom? Don't make me laugh. */ GOTO YvP5x04 
IF~~THEN REPLY @131 /* Shut up. We need to get going. */ GOTO YvP5x02 
IF~~THEN REPLY @132 /* My fair lady, so long as you can smile, you are free. */ GOTO YvP5x03 
END 

IF~~THEN BEGIN YvP5x03
SAY @133 /* Exactly, my <PRO_LADYLORD>. I couldn't have said it better myself. I am glad we agree with on this, <CHARNAME>. */
IF~~THEN GOTO YvP5x05 
END 

IF~~THEN BEGIN YvP5x04 
SAY @134 /* Laugh if you want, <CHARNAME>. I may be idealistic, but I prefer to see the world in bright shades rather than painted gray. */ 
IF~~THEN GOTO YvP5x05 
END 

IF~~THEN BEGIN YvP5x05 
SAY @135 /* There is something more. Whatever it is that separates me from my memories...it is breakable, I think. I believe that I may be able to leave this scroll, and become...part of your world. Just like your other companions, <CHARNAME>. What do you think? */ 
IF~~THEN REPLY @136 /* Your faith is really strong. I hope you do escape from your scroll. */ GOTO YvP5x06 
IF~~THEN REPLY @137 /* I would like that. I hope then that it will happen. */ GOTO YvP5x06 
IF~~THEN REPLY @138 /* You're ridiculous, you know that? A picture that thinks it could become a human! Ha! */ GOTO YvP5x07 
IF~~THEN REPLY @139 /* Done daydreaming? Good. The rest of us have things to do. */ GOTO YvP5x02 
END 

IF~~THEN BEGIN YvP5x06 
SAY @140 /* (Yvette smiles at you, her renewed faith lending a special brightness to her face. She looks past you to the world beyond.) */ 
IF~~THEN GOTO YvP5x08 
END 

IF~~THEN BEGIN YvP5x07 
SAY @141 /* You know, your life must be a sad one. You live with neither faith nor hope. */ 
...
SAY @142 /* I may stand there one day, gazing at the sky... */ 
IF~~THEN REPLY @143 /* Not "may" - you *will*. Don't doubt that, Yvette. */ GOTO YvP5x09 
IF~~THEN REPLY @144 /* Your optimism is almost as beautiful as you are. */ GOTO YvP5x10 
IF~~THEN REPLY @145 /* Enough dreaming. We have something more important to do. */ GOTO YvP5x02 
END 

IF~~THEN BEGIN YvP5x09 
SAY @146 /* I see that I'm not the only optimist here. Thank you. */ 
IF~~THEN DO ~SetGlobal("YvetteRomanceTalk","GLOBAL",5) SetGlobal("YvetteChange","GLOBAL",1)~ EXIT 
END 

IF~~THEN BEGIN YvP5x10 
SAY @147 /* Still trying to make me blush? Believe me - I would, if I could. */ 
= 
@148 /* But thank you. */ 
IF~~THEN DO ~SetGlobal("YvetteRomanceTalk","GLOBAL",5) SetGlobal("YvetteChange","GLOBAL",1)~ EXIT 
END 
...
SAY @149 /* I had not thought that you were so rude. */ 
