...
SAY @0 /* So you spoke again with this... portrait, didn't you? I'm not sure, <CHARNAME>, if you are aware that there are more important things than conversing with scraps of parchment. We should focus on saving Imoen and stopping Irenicus. */
IF~~THEN REPLY @1 /* What's wrong about talking with Yvette? Maybe she can't help us physically in battle, but she's still a companion. Of sorts. */ GOTO YxYCon001
IF~~THEN REPLY @2 /* You’re right, it's a little pathetic. If I was forced to chose between my living companions and her, I think it is obvious what the answer would be. */ GOTO YxYCon002
...
SAY @5 /* What? Just listen to yourself - is this piece of parchment more important to you than a friend who shared months of adventuring with you? Who traveled with you from Nashkel to Baldur's Gate? */
=
...
IF~~THEN REPLY @7 /* I don’t think the problem is my decisions, so much as your strange prejudice, Jaheira. */ GOTO YxYCon004
...
SAY @10 /* Excuse me? That was far too insolent, child. You should remember who you are speaking to. Is that how you would treat your friends? I thought that was what we were, but now I’m starting to doubt your good sense, 'good leader'. */
...
SAY @13 /* Fine, but there are more important things here than this Yvette – and that's a fact. You can't save the whole of Faerun – so you should focus on your main goal now instead of wasting time with her... This is neither the place nor the time for such games. */
...
SAY @17 /* My thanks. I appreciate your decision, and I'm glad you heed my advice, <CHARNAME>. Come, we shall find a way to rescue Imoen and get Irenicus before he causes more pain. */
IF~~THEN DO ~SetGlobal("YvetteJaheiraConflic","GLOBAL",1) SetGlobal("YvetteRomanceActive","GLOBAL",3)~ EXIT
END

IF~~THEN BEGIN YxYCon003
SAY @18 /* You really disappoint me, "my lord". Let's move them. I'm in no mood for further talk. */
IF~~THEN DO ~SetGlobal("YvetteJaheiraConflic","GLOBAL",1) SetGlobal("JaheiraRomanceActive","GLOBAL",3)~ EXIT
END
...
IF~~THEN REPLY @21 /* I really like her, Aerie. As you say, she seems a nice person and I really enjoy our talks. Sometimes she seems a bit idealistic, but that’s fine with me. I would even say it's charming. */ GOTO YxYCon101
IF~~THEN REPLY @22 /* She's just another priestess, who’s also quite skilled as a thief. That is all. */ GOTO YxYCon102
IF~~THEN REPLY @23 /* It's not your business, Aerie. Focus on your... prayers... or something. I'm not in the mood for this, Avariel. */ GOTO YxYCon103
END
...
SAY @35 /* That... that was really rude, <CHARNAME>. I though you... */
=
...
SAY @42 /* I just can't believe my ears! And what I should expect next? A picnic with pudding and baked apples?! I’m glad stupidity isn't contagious! Idiots! Aren’t we supposed to be doing something more important than that? */
=
...
SAY @52 /* I don’t understand what happened... Who was that girl? Yvette, you say? Well, I suppose you would make some friends on the way here. Do you know who that man was that she stayed with? */
...
SAY @56 /* I’m sure we'll get her out of that strange place somehow. You managed to save me, CHARNAME, so I guess nothing can stop you! */
=
...
IF~~THEN REPLY @59 /* Shall we go now? We should find a way out. */ GOTO YvImoen002
...
SAY @62 /* We'll find a way to do something about that nasty...thing, now that we're a team again. You saved me, so of course I’m gonna try to help you somehow! */
IF~~THEN DO ~SetGlobal("YvetteImoenReaction","GLOBAL",1)~ EXIT
END

IF~~THEN BEGIN YvImoen002
SAY @63 /* You're right! Come, <CHARNAME>! */
IF~~THEN DO ~SetGlobal("YvetteImoenReaction","GLOBAL",1)~ EXIT
END
END
